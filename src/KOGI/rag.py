...
class KOGI_FAQ:
    def __init__(self, embedding):
        ...
        self.vectordb = Chroma(
            persist_directory="./data/KOGI_VECTOR_STORE",
    ...
    def create_users_directory(self):
        ...
        self.directory = "./USERS/KOGI_USERS"
    ...
    def system_prompt(self, document, user_name):
        SYSTEM_PROMPT = f"""
        You are an FAQ chatbot designed to assist users by answering questions about topic for Kogi State. 
...
# faq = KOGI_FAQ(embedding_model)

# # ✅ Step 3: Test similarity search
# test_query = "what is kogi HEALTH PLANS?"
